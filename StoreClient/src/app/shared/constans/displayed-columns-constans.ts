...
export namespace DisplayedColumnsConstans {
   export const authors: string[] = ['id', 'name', 'product', 'editAndRemove'];
   export const myOrders: string[] = ['id', 'date', 'product', 'title', 'qty', 'orderAmount'];
